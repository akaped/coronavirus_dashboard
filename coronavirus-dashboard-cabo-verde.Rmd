---
title: "Coronavirus in Cabo Verde"
...
df <- coronavirus %>%
  ...
  dplyr::filter(Country.Region == "Cabo Verde") %>%
...
### **Daily cumulative cases by type** (Cabo Verde only)
...
**The Coronavirus Dashboard: the case of Cabo Verde**

This Coronavirus dashboard: the case of Cabo Verde provides an overview of the 2019 Novel Coronavirus COVID-19 (2019-nCoV) epidemic for Cabo Verde. This dashboard is built with R using the R Makrdown framework and was adapted from this [dashboard](https://ramikrispin.github.io/coronavirus_dashboard/){target="_blank"} by Rami Krispin.
